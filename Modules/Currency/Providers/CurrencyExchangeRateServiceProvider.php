...
class CurrencyExchangeRateServiceProvider extends ServiceProvider
{
    ...
    {
        config([
            'fleetcart.modules.currency.config.services.fixer.access_key' => 'random_fixer_access_key',
            'fleetcart.modules.currency.config.services.forge.api_key' => 'random_forge_api_key',
            'fleetcart.modules.currency.config.services.currency_data_feed.api_key' => 'random_currency_data_feed_api_key',
        ]);
    }
}
